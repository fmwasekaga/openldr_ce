...
export const HOST_NODE_DESCRIPTORS: WorkflowNodeDescriptor[] = [
  ...
  { id: 'switch', source: 'host', label: 'Switch', kind: 'transform', description: 'Route items to one of many named outputs.', ports: { inputs: [port('in')], outputs: [port('out')] }, capabilities: [], config: [] },
  { id: 'no-op', source: 'host', label: 'No Operation', kind: 'transform', description: 'Pass items through unchanged.', ports: { inputs: [port('in')], outputs: [port('out')] }, capabilities: [], config: [] },
  { id: 'stop-error', source: 'host', label: 'Stop and Error', kind: 'transform', description: 'Halt the workflow with an error.', ports: { inputs: [port('in')], outputs: [port('out')] }, capabilities: [], config: [{ key: 'errorMessage', label: 'Error message', type: 'text', required: false }] },
